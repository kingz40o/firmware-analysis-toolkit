...
cd binwalk
sed -i '/git clone --quiet --depth 1 --branch "master" https:\/\/github.com\/jrspruitt\/ubi_reader/c\git clone --quiet --depth 1 --branch "main" https:\/\/github.com\/jrspruitt\/ubi_reader' deps.sh
